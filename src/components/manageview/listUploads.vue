...
export default {
  data() {
    ...
    return {
      ...
      songdetails,
      schema_song: {
        song_modified_name: "required|min:6|max:100",
        song_artist: "required|min:1|max:100",
        song_genre: "required|min:3|max:100",
      },
    };
  },
  props: {
